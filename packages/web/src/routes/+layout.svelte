...
<style>
  ...
  :global(:root) {
    /*
     * Geometry and typefaces only. The colours - this theme's and every
     * other's - are generated into $lib/themes.generated.css from
     * scripts/theme/palette.cjs, which is where to change one.
     */
