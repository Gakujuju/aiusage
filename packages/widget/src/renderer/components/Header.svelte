...
<div class="header">
  ...
  <div class="actions">
    <button class="icon-btn" title={refreshLabel} aria-label={refreshLabel} on:click={onRefresh}>
    ...
    <button class="icon-btn" title={settingsLabel} aria-label={settingsLabel} on:click={onToggleSettings}>
